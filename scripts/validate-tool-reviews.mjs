...
const required = [
  ...
  "review.reported", "developer.section.toolReviews", "developer.section.toolReviewReports",
  ...
  "developer.toolReviews.confirm.hide", "developer.toolReviews.confirm.remove",
