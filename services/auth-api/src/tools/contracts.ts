...
export type ToolSort = "newest" | "updated" | "name" | "popular" | "trending" | "most_downloaded" | "recommended" | "top_rated";
...
export type ToolErrorCode = "INVALID_TOOL" | "INVALID_TOOL_QUERY" | "INVALID_TOOL_URL" |
  ...
  "REVIEW_NOT_FOUND" | "REVIEW_ALREADY_EXISTS" | "REVIEW_BODY_REQUIRED" | "REVIEW_BODY_TOO_LONG" |
  "REVIEW_TITLE_TOO_LONG" | "REVIEW_NOT_EDITABLE" | "REVIEW_ALREADY_REPORTED" | "REVIEW_SELF_REPORT_DENIED" |
  "REVIEW_MODERATION_REASON_TOO_LONG" | "REPORT_NOT_FOUND" | "REPORT_REASON_REQUIRED" |
  "REPORT_REASON_INVALID" | "REPORT_DETAILS_TOO_LONG" | "REVIEW_NOT_AVAILABLE" | "CANNOT_VOTE_OWN_REVIEW" |
  "REPLY_BODY_REQUIRED" | "REPLY_BODY_TOO_LONG" | "REPLY_NOT_FOUND";
